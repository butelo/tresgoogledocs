...
public class ObjetoEscaleta {
	...
	public String toString() {
		return "ObjetoEscaleta [titulo=" + titulo + ", timestamp=" + timestamp
				+ ", ordensec=" + ordensec + ", intext=" + intext
				+ ", dianoche=" + dianoche + ", lugar=" + lugar + ", accion="
				+ accion + ", personajes=" + personajes + "]";
	}
